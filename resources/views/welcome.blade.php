        ...
        <div class="bcg skrollable skrollable-between" data-anchor-target="#parallax-1" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -100px;" data-bottom-top="background-position: 50% 100px;">
            <div class="hero-body">
                <div class="hero-text text-center">
                    <h1>
                        I'm Jeimi Woffinden <span class="blinker"></span>
                    </h1>

                    <h1 class="small">Frontend Web / Graphic Designer</h1>

                    <p>Passionate - Hardworking - Dedicated</p>
...
<nav id="navigation" class="navbar navbar-fixed-top center-menu" role="navigation">
    <div class="container navbar-container">
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand visible-xs visible-sm" href="#page-top">WOFFINDEN</a>
        </div>
        <!-- //.navbar-header -->
                    ...
                    <div class="profile-text padding-right-yes">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>
                                    I pride myself in being a passionate and dedicated frontend web developer and graphic designer with a variety of professional experience.
                                </p>
            ...
            <div class="portfolio">
                <div class="row">
                    ...
                    <div class="item col-sm-6 col-md-3">
                        <div class="project-wrapper">
                            <div class="project-link">
                                <a href="assets/images/portfolio/project-image-2.jpg" class="zoom" title="Real Estate Company Website">
                                    <i class="icon-Full-Screen"></i>
                                </a>
                            ...
                            <div class="project-title">
                                <h4>Coastal Real Estate Group</h4>
                            </div>
                            <!-- //.project-title -->
                    ...
                    <div class="item col-sm-6 col-md-3">
                        <div class="project-wrapper">
                            <div class="project-link">
                                <a href="assets/images/portfolio/project-image-5.jpg" class="zoom" title="Midnight Sun Excursions">
                                    <i class="icon-Full-Screen"></i>
                                </a>

                                <a href="https://www.midnightsunexcursions.com" target="_blank" class="external-link">
                                    <i class="icon-Link"></i>
                                </a>
                            </div>
                            <!-- //.project-link -->
                    ...
                    <div class="item col-sm-6 col-md-3">
                        <div class="project-wrapper">
                            <div class="project-link">
                                <a href="assets/images/portfolio/project-image-6.jpg" class="zoom" title="Southeast Alaska Power Agency">
                                    <i class="icon-Full-Screen"></i>
                                </a>

                                <a href="https://www.seapahydro.org" target="_blank" class="external-link">
                                    <i class="icon-Link"></i>
                                </a>
                            </div>
                            <!-- //.project-link -->
                            ...
                            <div class="project-title">
                                <h4>Southeast Alaska Power Agency</h4>
                            </div>
                            <!-- //.project-title -->
                    ...
                    <div class="item col-sm-6 col-md-3">
                        <div class="project-wrapper">
                            <div class="project-link">
                                <a href="assets/images/portfolio/project-image-7.jpg" class="zoom" title="Skagway Fishing Charters">
                                    <i class="icon-Full-Screen"></i>
                                </a>

                                <a href="https://www.skagwayfishingcharters.com" target="_blank" class="external-link">
                                    <i class="icon-Link"></i>
                                </a>
                            </div>
                            <!-- //.project-link -->
                            ...
                            <div class="project-title">
                                <h4>Skagway Fishing Charters</h4>
                            </div>
                            <!-- //.project-title -->
...
<section id="services" class="section">
    <div class="container section-wrapper">
        <div class="section-content">
            ...
            <div class="services">
                <div class="row">
                    <div class="col-sm-4 item top dark-bg match-height">
                    ...
                    <div class="col-sm-4 item top match-height">
                        <div class="inner-content">
                    ...
                    <div class="col-sm-4 item match-height">
                        <div class="inner-content">
                            ...
                            <p class="text-grey">
                                Social media binds together communities that once were geographically isolated, greatly increasing the pace and intensity of collaboration.
                            </p>
                        </div>
                        <!-- //.inner-content -->
                    </div>
                    ...
                    <div class="col-sm-4 item dark-bg match-height">
                        <div class="inner-content">
                        ...
                        <div class="chart clearfix">
                            <div class="item">
                                <div class="bar">
                                    ...
                                    <div class="item-progress" data-percent="87">
            ...
            <div class="row education">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel-group resume" id="education">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class="resume-title">Laracasts - Online Tutorials</h4>
                                    </div>
                                    <!-- //.panel-title -->
                                </div>
                                <!-- //.panel-heading -->
                        ...
                        <div class="resume-item">
                            <div class="resume-year">
                                <span class="resume-year">2014</span>
                            </div>
                            <!-- //.resume-year -->
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class="resume-title">DevMountain - Coding Bootcamp</h4>
                                    </div>
                                    <!-- //.panel-title -->
                                </div>
                                <!-- //.panel-heading -->
                        ...
                        <div class="resume-item">
                            <div class="resume-year">
                                <span class="resume-year">2008 - 2014</span>
                            </div>
                            <!-- //.resume-year -->
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class="resume-title">Online Tutorials - Lynda.com subscription</h4>
                                    </div>
                                    <!-- //.panel-title -->
                                </div>
                                <!-- //.panel-heading -->
                        ...
                        <div class="resume-item">
                            ...
                            <div class="resume-btn">
                                <a href="#education4" data-toggle="collapse" data-parent="#education"></a>
                            </div>
                            <!-- //.resume-btn -->
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class="resume-title">Bachelor's Degree - Utah State University</h4>
                                    </div>
                                    <!-- //.panel-title -->
                                </div>
                                <!-- //.panel-heading -->
                                ...
                                <div id="education1" class="panel-collapse collapse in">
                                    <div class="panel-body text-grey">
                                        <p>
                                            Bachelors of Fine Arts. I majored in Graphic Design with a minor in
            ...
            <div class="row work-experience">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel-group resume" id="work">
                        ...
                        <div class="resume-item">
                            <div class="resume-year">
                                <span class="resume-year">2000 - 2010</span>
                            </div>
                            <!-- //.resume-year -->
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class="resume-title">Graphic and Web Designer - Dynatronics Corporation</h4>
                                    </div>
                                    <!-- //.panel-title -->
                                </div>
                                <!-- //.panel-heading -->
                        ...
                        <div class="slides">
                            ...
                            <div class="item">
                                <div class="animated" data-animation-effect="flipInX">
                                    ...
                                    <div class="content">
                                        <h3>EXIT GROUP, INC</h3>

                                        <p>
                                            "Jeimi not only has an eye and understanding of what looks good, she also has a keen knowledge and understanding of how users would naturally interact with systems.  She constantly steps back from a design and questions if this is a clear and natural way for user to interact with the system and is alway adapting to make the best changes from that perspective.

                                            Jeimi's knowledge of both front and back end design is invaluable when it comes to project designs, as she keeps both perspectives in mind and can limit the amount of redesign on the the UI for long projects."
                                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-2">
                        <div class="item">
                            ...
                            <h4 class="text-center">Illustrator</h4>
                        </div>
                        <!-- //.item -->
                    </div>
                    <!-- //.col-md-2 -->
    ...
    <div class="container section-wrapper">
        <div class="section-content">
            ...
            <div class="work-process">
                <div class="row">
                    <div class="col-sm-2 item no-margin first">
                        <div class="inner-content">
                    ...
                    <div class="col-sm-2 item no-margin">
                        <div class="inner-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-grey text-justify">
                        The six steps from a great idea to a successful launch. Each step is important. mafei maoei mio
                    </p>
                </div>
                <!-- //.col-md-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="contact-details text-center">
                        ...
                        <h2>Jeimi <strong>Woffinden</strong></h2>

                        <h4 class="text-grey">jeimi@yahoo.com</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="list-inline social-icons">
                    ...
                    <li>
                        <div class="item">
                            <a href="https://www.linkedin.com/in/jeimi-woffinden-044682a6" target="_blank"><i class="fa fa-linkedin"></i></a>
                        </div>
                        <!-- //.item -->
                    </li>
                    ...
                    <li>
                        <div class="item">
                            <a href="https://github.com/woffj" target="_blank"><i class="fa fa-git" aria-hidden="true"></i></a>
                        </div>
                        <!-- //.item -->
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright text-center">
                    <p class="text-grey">&copy; 2016 Jeimi Woffinden. All rights reserved.</p>
                </div>
                <!-- //.copyright -->
            </div>
            <!-- //.col-md-12 -->
