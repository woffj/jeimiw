                            ...
                            <div class="item">
                                <div class="animated" data-animation-effect="flipInX">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            "Jeimi not only has an eye and understanding of what looks good, she also has a keen knowledge and understanding of how users would naturally interact with systems.  She constantly steps back from a design and questions if this is a clear and natural way for user to interact with the system and is always adapting to make the best changes from that perspective.

                                            Jeimi's knowledge of both front and back end design is invaluable when it comes to project designs, as she keeps both perspectives in mind and can limit the amount of redesign on the UI for long projects."
                                        </p>
